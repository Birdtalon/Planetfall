...
/datum/controller/subsystem/dbcore/Shutdown()
	...
	if(SSdbcore.Connect())
		var/sql_colony_name = sanitizeSQL(colony_name())
		var/datum/DBQuery/query_round_end = SSdbcore.NewQuery("UPDATE [format_table_name("round")] SET end_datetime = Now(), game_mode_result = '[SSticker.mode_result]', end_state = '[SSticker.end_state]', colony_name = '[sql_colony_name]' WHERE id = [GLOB.round_id]")
