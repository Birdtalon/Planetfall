...
/datum/game_mode/nuclear/declare_completion()
	...
	if(nuke_off_station == NUKE_SYNDICATE_BASE)
		...
		to_chat(world, "<B>The crew of [colony_name()] gave [syndicate_name()] operatives back their bomb! The syndicate base was destroyed!</B> Next time, don't lose the nuke!")
		...
		to_chat(world, "<B>[syndicate_name()] operatives have destroyed [colony_name()]!</B>")
		...
		to_chat(world, "<B>[syndicate_name()] operatives destroyed [colony_name()] but did not leave the area in time and got caught in the explosion.</B> Next time, don't lose the disk!")
		...
		to_chat(world, "<B>[syndicate_name()] operatives secured the authentication disk but blew up something that wasn't [colony_name()].</B> Next time, don't do that!")
		...
		to_chat(world, "<B>[syndicate_name()] operatives blew up something that wasn't [colony_name()] and got caught in the explosion.</B> Next time, don't do that!")
		...
		to_chat(world, "<B>[syndicate_name()] operatives survived the assault but did not achieve the destruction of [colony_name()].</B> Next time, don't lose the disk!")
