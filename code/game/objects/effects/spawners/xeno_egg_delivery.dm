...
/obj/effect/spawner/xeno_egg_delivery/Initialize(mapload)
	...
	var/message = "Attention [colony_name()], we have entrusted you with a research specimen in [A]. Remember to follow all safety precautions when dealing with the specimen."
