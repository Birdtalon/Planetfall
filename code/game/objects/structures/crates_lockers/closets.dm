/obj/structure/closet
	...
	var/lock_sound = 'sound/effects/lock.ogg'
	var/unlock_sound = 'sound/effects/unlock.ogg'
	var/rattle_sound = 'sound/effects/doorrattle.ogg'
...
/obj/structure/closet/proc/create_lock(mob/user, obj/item/weapon/lock/lock_assy/L)
